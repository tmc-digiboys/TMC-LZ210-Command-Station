...
// ─────────────────────────────────────────────────────────────
#define LED_PIN_STATUS   HW_LED_STATUS_PIN
...
// ─────────────────────────────────────────────────────────────
//  LedStatus — controller for all four status LEDs
//
//  status: track power (solid on = powered, fast blink = short circuit)
...
public:
    ...
    // begin() — initialises all four LED pins as outputs, driving
