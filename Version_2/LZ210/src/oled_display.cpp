...
// bytes for this page, using a longer timeout than _cmd() (see
// OLED_PAGE_WRITE_TIMEOUT_US) since this transfer is considerably
// larger and must scale with whatever I2C clock is configured.
void OledDisplay::_writePage(uint8_t page) {
    ...
    i2c_write_timeout_us(OLED_I2C, OLED_I2C_ADDR,
                         txbuf, OLED_WIDTH + 1, false, OLED_PAGE_WRITE_TIMEOUT_US);
}
